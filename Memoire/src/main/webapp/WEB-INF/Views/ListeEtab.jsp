...
<html>
    <head>
        <title>Liste Etablissement</title>
        <meta charset="UTF-8">
	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2>Liste <b> Liste des établissements</b></h2>
					</div>
					<div class="col-sm-6">
						<a href="#editEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Valider</span></a>
...
<!-- 						<th>Is valide</th> -->
				...
				<tbody>
					...
					<tr>
						<td class="column1">${listeOffre.email}</td>
						<td class="column2">${listeOffre.nom_etablissement}</td>
						<td class="column3">${listeOffre.num_tel}</td>
						<td class="column4">${listeOffre.siege}</td>
						<td class="column5">${listeOffre.niveau}</td>
						<td class="column6">${listeOffre.filiere}</td>
						<td class="column7">${listeOffre.diplome}</td>
						<td class="column8">${listeOffre.region}</td>
						<td class="column9">${listeOffre.ville}</td>
<%-- 						<td class="column6">${listeOffre.cv}</td> --%>
<%--  						<td class="column7">${listeOffre.is_valide}</td> --%>
					</tr>
					</c:forEach>
				</tbody>
			</table>
...
<div id="deleteEmployeeModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="DeleteEtablissement" method="POST">
...
<!-- Valider Modal HTML -->
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="/ValideEtablissement" method="POST">
