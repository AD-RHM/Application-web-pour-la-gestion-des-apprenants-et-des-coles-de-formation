...
<html>
    ...
    <body>
        ...
        <br><br><br>
        <h3 class="added" align="center">${offreadded}</h3>
        <h3 class="deleted" align="center">${offredeleted}</h3>
        <h3 class="edited" align="center">${offreedited}</h3>
        
        <h3 class="added" align="center">${formationadded}</h3>
        <h3 class="deleted" align="center">${formationdeleted}</h3>
        <h3 class="edited" align="center">${formationedited}</h3>
...
<nav>
    ...
    <ul class="menu">
       <li><a href="EtablissementProfile"><i class="fas fa-user-circle"></i> Compte</a></li>

       
       <li>
        <label for="btn-2" class="first"><i class="far fa-edit"></i> Gestion des offres
        <span class="fas fa-caret-down"></span>
        </label>
        <input type="checkbox" id="btn-2">
        <ul>
           <li><a href="OffresEmploiPro"><i class="fas fa-angle-right"></i>Offre d'emploi</a></li>
           <li><a href="OffresDeFormationPro"><i class="fas fa-angle-right"></i>Offres de formation</a></li>
        </ul>
     </li>
            <li><a href="#"><i class="far fa-check-circle"></i> Traitement des condidatures</a></li>
     ...
     <li>
        ...
        <ul>
           ...
           <li><a href="#"><i class="fas fa-angle-right"></i>Apprenant</a></li>
        </ul>
