...
<nav>
    ...
    <ul class="menu">
       <li><a href="FormateurProfile"><i class="fas fa-user-circle"></i> Compte</a></li>
       <li><a href="OffreEnAttente"><i class="fas fa-clipboard-list"></i> Offres en attente</a></li>
       <li><a href="#"><i class="fas fa-info-circle"></i> Proposer formation</a></li>
