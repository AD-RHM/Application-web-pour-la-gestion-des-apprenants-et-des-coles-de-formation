	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2>Liste <b> Liste des formateurs</b></h2>
					</div>
					<div class="col-sm-6">
...
<!-- 						<th>Is valide</th> -->
				...
				<tbody>
					...
					<tr>
						...
						<td class="column2">${listeOffre.nom}</td>
						<td class="column3">${listeOffre.prenom}</td>
						<td class="column4">${listeOffre.num_tel}</td>
						<td class="column5">${listeOffre.adresse}</td>
...
<div id="deleteEmployeeModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="DeleteFormateur" method="POST">
...
<!-- Valide Modal HTML -->
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="ValideFormateur" method="POST">
