			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td class="column3">${listeOffre.designation}</td>
						<td class="column4">${listeOffre.description}</td>
						<td class="column5">${listeOffre.contrat}</td>
						<td class="column6">${listeOffre.minexpr}</td>
						<td class="column7">${listeOffre.salaire}</td>
					</tr>
					</c:forEach>
				</tbody>
			</table>
...
<div id="addEmployeeModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="AddOffreEmploi" method="POST">
				...
				<div class="modal-body">	
					...
					<div class="form-group">
						<label>Min d'experènce</label>
						<input type="text" class="form-control" name="minexpr">
					</div>
...
<div id="deleteEmployeeModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="DeleteOffreEmploi" method="POST">
				<div class="modal-body">
				<div class="form-group">
						<label>Id</label>
...
<!-- Update Modal HTML -->
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="UpdateOffreEmploi" method="POST">
				...
				<div class="modal-body">	
					...
					<div class="form-group">
						<label>Contrat</label>
						<input type="text" class="form-control" required name="contrat">
					</div>
					<div class="form-group">
						<label>Min d'experience</label>
						<input type="text" class="form-control" required name="minexpr">
					</div>
					<div class="form-group">
						<label>Salaire</label>
						<textarea class="form-control" required name="salaire"></textarea>
					</div>
