...
<html>
    <head>
        <title>Etablissement par filiere</title>
        <meta charset="UTF-8">
	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2>Liste <b> Etablissements par filière</b></h2>
					</div>
			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					...
					<tr>
						<td class="column1">${listeOffre.nom_etablissement}</td>
						<td class="column2">${listeOffre.filiere}</td>
